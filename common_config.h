...
#define SAMPLE_Q_SIZE  32// how large is the original ring buffer?
typedef struct {
...
#define COMPRESSED_BUFFER_SIZE 80 // must be N_COMPRESSION * NUM_SAMPLES


#define NUM_LEVELS 6 // should be floor(log2(COMPRESSED_BUFFER_SIZE)), always!!!
#define TEST_WAVELET "db4"
#define NUM_CHANNELS 1
#define MAX_CODEWORDS COMPRESSED_BUFFER_SIZE/2
